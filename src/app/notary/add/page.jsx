...
export default function AddNotaryPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.error(err);
      setError("Failed to submit entry. Please check your network connection.");
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="flex bg-zinc-50 min-h-screen font-sans">
      ...
      <main className="flex-1 p-8 md:p-10 max-w-2xl mx-auto overflow-hidden">
        ...
        <div className="mb-8">
          ...
          <p className="text-zinc-500 mt-2">Log document signatures, stamp duties, and ledger fees in the official Notary Register.</p>
        </div>
        ...
        <div className="bg-white border border-zinc-200/85 p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
          {fetchingClients ? (
            <div className="py-20 flex flex-col items-center justify-center gap-3">
              ...
              <p className="text-sm text-zinc-500 font-medium">Booting client data directories...</p>
            </div>
          ) : (
